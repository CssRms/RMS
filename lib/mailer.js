...
function buildTransport() {
  ...
  if (gmailUser && gmailPass) {
    // Strip spaces from App Password — Railway/display formatting adds spaces but Gmail wants them gone
    const cleanPass = gmailPass.replace(/\s/g, '');
    console.log(`[MAIL] Building Gmail transport for ${gmailUser} (pass: ${cleanPass.length} chars)`);
